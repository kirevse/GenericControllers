...
namespace GenericControllers.Features
{
    ...
    {
        protected Action<IGenericControllersOptions> GenericControllersOptionsAction { get; }

        public GenericControllerFeatureProvider(Action<IGenericControllersOptions> genericControllersOptionsAction) =>
